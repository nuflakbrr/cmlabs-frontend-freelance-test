...
import { getFilterByAreaAction } from '@/redux/actions/mealAction';
...
interface LocalCulinaryMealsContentProps {
  area: string;
}

export const LocalCulinaryMealsContent: FC<LocalCulinaryMealsContentProps> = ({ area }) => {
  ...
  useEffect(() => {
    dispatch(getFilterByAreaAction(area));
  ...
  return (
    <section className="py-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 lg:px-20 pt-28 pb-20">
        <GenericBreadcrumb
          items={[
            ...
            {filteredMeals.length === 0 && !isFetching && (
              <Empty className="py-20 text-center">
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    We couldn&rsquo;t find any regional dishes matching &rdquo;{searchTerm}&rdquo;
                    in {area}.
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
